        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              My Career Journey in Data Science & Analytics
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-l-4 border-orange-500">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700">
                  Working as part of the cross-functional Business Intelligence
                  team, supporting multiple departments with a particular focus
                  on Marketing and HR operations.
                </p>
              </div>
                    ...
                    <li key={i} className="flex items-start">
                      ...
                      <span
                        dangerouslySetInnerHTML={{
                          __html: text.replace(
                            /(dbt|PostgreSQL|Tableau|documentation|dashboards|Business Intelligence)/g,
                            '<strong>$1</strong>'
                          ),
                        }}
                      />
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-l-4 border-blue-500">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700">
                  Worked as part of the Customer Data Team on multiple innovative
                  projects involving cloud infrastructure, machine learning, data
                  pipeline automation, LLMs, Vector Databases, CI/CD, and more.
                </p>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-l-4 border-green-500">
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-green-600 font-semibold text-lg">
                    KR&A Real Estate DataAnalysis FinTech Start-Up
                  </p>
                  <div className="flex items-center text-gray-600 mt-2">
                    <Calendar className="w-4 h-4 mr-2" />
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700">
                  Supporting decision-making, providing insights and up-to-date
                  data in the Real Estate sector. Focused on data collection,
                  processing, and analysis for market intelligence.
                </p>
              </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700 ml-4">
                      <li className="flex items-start">
                        ...
                        <span>
                          <strong>Web Scraping with Python</strong> using{' '}
                          <strong>Scrapy, Selenium</strong> and{' '}
                          <strong>BeautifulSoup</strong> (also on dynamic websites)
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700 ml-4">
                      <li className="flex items-start">
                        <span className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0" />
                        <span>
                          Analysed complex, high-volume, high-dimensionality data
                          from varying sources using <strong>Python</strong> and{' '}
                          <strong>SQL</strong>.
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0" />
                        Identified and evaluated the quality of different data
                        sources
                      </li>
                    </ul>
                  </div>
