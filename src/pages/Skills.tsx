  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "scikit-learn", level: 80, description: "Supervised/unsupervised models, pipelines, preprocessing" }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "Snowflake", level: 70, description: "ETL and dbt connections"}
      ]
    },
    {
      title: "Cloud & DevOps",
