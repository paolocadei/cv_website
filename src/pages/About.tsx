            ...
            <div className="flex flex-col lg:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-gray-700 leading-relaxed text-lg">
                  After completing a Master’s in Data Science and Business Analytics at the University of Amsterdam, I started working full-time as an Analytics Engineer at Perk. I love all things data, especially when it involves building cool stuff with code, automating tasks, or exploring the power of AI and large language models. Outside of work, you'll find me reading, bouldering, meditating, or deep into a board game, amongst other things :)
                </p>
              </div>
            </div>
          </div>
